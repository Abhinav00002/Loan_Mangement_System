...
public class Deposit {
	...
	public Deposit(int id, int branchId, String branchName, Double amount, int bankId, String bankName,
			String bankType, LocalDate entryDate, int clearStatus, Date dcrDate, Date depositDate, int entryBy,
			int clearBy, Date clearDate) {
		super();
		this.id = id;
		this.branchId = branchId;
		this.branchName = branchName;
	...
	public String toString() {
		return "Deposit [id=" + id + ", branchId=" + branchId + ", branchName=" + branchName + ", amount=" + amount
				...
				+ ", entryBy=" + entryBy + ", clearBy=" + clearBy + ", clearDate=" + clearDate + "]";
	}
